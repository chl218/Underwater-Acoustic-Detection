...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.peaks.autotvin_samples_V.dat"
         "c.peaks.autotvin_amplitude_V.dat"
         "c.peaks.autotvin_locations_V.dat"
         "c.peaks.autotvout_amplitude_V.dat"
         "c.peaks.autotvout_locations_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.peaks.autotvout_amplitude_V.dat"
         "rtl.peaks.autotvout_locations_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
