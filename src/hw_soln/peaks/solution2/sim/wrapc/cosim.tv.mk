...
$(ObjDir)/peaks_tb.cpp_pre.cpp.tb.o : peaks_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling peaks_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/peaks.cpp_pre.cpp.tb.o : peaks.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling peaks.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
