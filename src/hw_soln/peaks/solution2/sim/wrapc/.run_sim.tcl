...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "peaks.autotvin.dat"
	set constFileTvOut       "peaks.autotvout.dat"
	set constFileHdlTvIn     "peaks.autohdltvin.dat"
	set constFileHdlTvOut    "peaks.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
