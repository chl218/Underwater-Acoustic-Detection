...
$(ObjDir)/running_threshold_tb.cpp_pre.cpp.tb.o : running_threshold_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling running_threshold_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/running_threshold.cpp_pre.cpp.tb.o : running_threshold.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling running_threshold.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
