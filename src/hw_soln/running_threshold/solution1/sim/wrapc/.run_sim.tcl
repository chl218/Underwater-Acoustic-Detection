...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "running_threshold.autotvin.dat"
	set constFileTvOut       "running_threshold.autotvout.dat"
	set constFileHdlTvIn     "running_threshold.autohdltvin.dat"
	set constFileHdlTvOut    "running_threshold.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
