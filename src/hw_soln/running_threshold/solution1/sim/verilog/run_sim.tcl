...
if {[file isfile running_threshold.autotvin.dat]} {
	file delete -force running_threshold.autotvin.dat
}

if {[file isfile running_threshold.autotvout.dat]} {
	file delete -force running_threshold.autotvout.dat
}
