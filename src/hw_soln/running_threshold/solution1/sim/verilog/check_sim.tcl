...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.running_threshold.autotvin_amplitude_V.dat"
         "c.running_threshold.autotvin_threshold_V.dat"
         "c.running_threshold.autotvout_threshold_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.running_threshold.autotvout_threshold_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
