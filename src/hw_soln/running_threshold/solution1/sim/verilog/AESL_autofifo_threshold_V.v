...
module AESL_autofifo_threshold_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.running_threshold.autotvin_threshold_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.running_threshold.autotvout_threshold_V.dat";
