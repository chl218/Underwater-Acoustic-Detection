...
#ifndef __signal_hits_fcmp_32ns_32ns_1_4__HH__
#define __signal_hits_fcmp_32ns_32ns_1_4__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(signal_hits_fcmp_32ns_32ns_1_4) {
    ...
    SC_CTOR(signal_hits_fcmp_32ns_32ns_1_4):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
