; ModuleID = 'C:/Users/Jack/Desktop/cse237d/Underwater-Acoustic-Detection/src/hw_soln/signal_hits/solution1/.autopilot/db/a.g.1.bc'
...
; [#uses=0]
define void @signal_hits(float %threshold, %"class.hls::stream.29"* %signals, %"class.hls::stream.29"* %hits, %"class.hls::stream.0.30"* %locs) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{float %threshold}, i64 0, metadata !2758), !dbg !2759 ; [debug line = 3:28] [debug variable = threshold]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.29"* %signals}, i64 0, metadata !2760), !dbg !2761 ; [debug line = 4:19] [debug variable = signals]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.29"* %hits}, i64 0, metadata !2762), !dbg !2763 ; [debug line = 5:19] [debug variable = hits]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.30"* %locs}, i64 0, metadata !2764), !dbg !2765 ; [debug line = 6:19] [debug variable = locs]
  %signals.addr = getelementptr inbounds %"class.hls::stream.29"* %signals, i64 0, i32 0, !dbg !2766 ; [#uses=1 type=float*] [debug line = 131:9@10:22]
  %hits.addr = getelementptr inbounds %"class.hls::stream.29"* %hits, i64 0, i32 0, !dbg !2772 ; [#uses=1 type=float*] [debug line = 146:9@12:4]
  %locs.addr = getelementptr inbounds %"class.hls::stream.0.30"* %locs, i64 0, i32 0, !dbg !2776 ; [#uses=1 type=i32*] [debug line = 146:9@13:4]
  br label %1, !dbg !2779                         ; [debug line = 8:15]

; <label>:1                                       ; preds = %._crit_edge, %0
  %tmp.5 = phi i32 [ 0, %0 ], [ %i, %._crit_edge ] ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %tmp.5, 120000, !dbg !2779 ; [#uses=1 type=i1] [debug line = 8:15]
  br i1 %exitcond, label %4, label %2, !dbg !2779 ; [debug line = 8:15]

; <label>:2                                       ; preds = %1
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2780 ; [#uses=1 type=i32] [debug line = 8:36]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2781 ; [debug line = 9:1]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.29"* %signals}, i64 0, metadata !2782), !dbg !2784 ; [debug line = 129:56@10:22] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{float* %tmp}, metadata !2785) nounwind, !dbg !2786 ; [debug line = 130:22@10:22] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.floatP.floatP(float* %signals.addr, float* %tmp) nounwind, !dbg !2766 ; [debug line = 131:9@10:22]
  call void @llvm.dbg.value(metadata !{float* %tmp}, i64 0, metadata !2785), !dbg !2787 ; [debug line = 132:9@10:22] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{float* %tmp}, i64 0, metadata !2785), !dbg !2787 ; [debug line = 132:9@10:22] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{float* %tmp}, i64 0, metadata !2785), !dbg !2787 ; [debug line = 132:9@10:22] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{float* %tmp}, i64 0, metadata !2785), !dbg !2787 ; [debug line = 132:9@10:22] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{float* %tmp}, i64 0, metadata !2785), !dbg !2787 ; [debug line = 132:9@10:22] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{float* %tmp}, i64 0, metadata !2785), !dbg !2787 ; [debug line = 132:9@10:22] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{float* %tmp}, i64 0, metadata !2785), !dbg !2787 ; [debug line = 132:9@10:22] [debug variable = tmp]
  %currAmp = load float* %tmp, align 4, !dbg !2787 ; [#uses=2 type=float] [debug line = 132:9@10:22]
  call void @llvm.dbg.value(metadata !{float %currAmp}, i64 0, metadata !2788), !dbg !2768 ; [debug line = 10:22] [debug variable = currAmp]
  %tmp.1 = fcmp ogt float %currAmp, %threshold, !dbg !2789 ; [#uses=1 type=i1] [debug line = 11:3]
  br i1 %tmp.1, label %3, label %._crit_edge, !dbg !2789 ; [debug line = 11:3]

; <label>:3                                       ; preds = %2
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.29"* %hits}, i64 0, metadata !2790), !dbg !2791 ; [debug line = 144:48@12:4] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{float* %tmp.2}, metadata !2792) nounwind, !dbg !2793 ; [debug line = 145:22@12:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{float %currAmp}, i64 0, metadata !2792), !dbg !2794 ; [debug line = 145:31@12:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{float %currAmp}, i64 0, metadata !2792), !dbg !2794 ; [debug line = 145:31@12:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{float %currAmp}, i64 0, metadata !2792), !dbg !2794 ; [debug line = 145:31@12:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{float %currAmp}, i64 0, metadata !2792), !dbg !2794 ; [debug line = 145:31@12:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{float %currAmp}, i64 0, metadata !2792), !dbg !2794 ; [debug line = 145:31@12:4] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{float %currAmp}, i64 0, metadata !2792), !dbg !2794 ; [debug line = 145:31@12:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{float %currAmp}, i64 0, metadata !2792), !dbg !2794 ; [debug line = 145:31@12:4] [debug variable = tmp]
  store float %currAmp, float* %tmp.2, align 4, !dbg !2794 ; [debug line = 145:31@12:4]
  call void @_ssdm_op_IfWrite.Stream.floatP.floatP(float* %hits.addr, float* %tmp.2) nounwind, !dbg !2772 ; [debug line = 146:9@12:4]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.30"* %locs}, i64 0, metadata !2795), !dbg !2797 ; [debug line = 144:48@13:4] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i32* %tmp.4}, metadata !2798) nounwind, !dbg !2799 ; [debug line = 145:22@13:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %tmp.5}, i64 0, metadata !2798), !dbg !2800 ; [debug line = 145:31@13:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %tmp.5}, i64 0, metadata !2798), !dbg !2800 ; [debug line = 145:31@13:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %tmp.5}, i64 0, metadata !2798), !dbg !2800 ; [debug line = 145:31@13:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %tmp.5}, i64 0, metadata !2798), !dbg !2800 ; [debug line = 145:31@13:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %tmp.5}, i64 0, metadata !2798), !dbg !2800 ; [debug line = 145:31@13:4] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i32 %tmp.5}, i64 0, metadata !2798), !dbg !2800 ; [debug line = 145:31@13:4] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i32 %tmp.5}, i64 0, metadata !2798), !dbg !2800 ; [debug line = 145:31@13:4] [debug variable = tmp]
  store i32 %tmp.5, i32* %tmp.4, align 4, !dbg !2800 ; [debug line = 145:31@13:4]
  call void @_ssdm_op_IfWrite.Stream.i32P.i32P(i32* %locs.addr, i32* %tmp.4) nounwind, !dbg !2776 ; [debug line = 146:9@13:4]
  br label %._crit_edge, !dbg !2801               ; [debug line = 14:3]

._crit_edge:                                      ; preds = %3, %2
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !2802 ; [#uses=0 type=i32] [debug line = 15:2]
  %i = add nsw i32 %tmp.5, 1, !dbg !2803          ; [#uses=1 type=i32] [debug line = 8:30]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !2804), !dbg !2803 ; [debug line = 8:30] [debug variable = i]
  br label %1, !dbg !2803                         ; [debug line = 8:30]

; <label>:4                                       ; preds = %1
  ret void, !dbg !2805                            ; [debug line = 17:1]
}
...
!869 = metadata !{i32 786478, i32 0, metadata !870, metadata !"signal_hits", metadata !"signal_hits", metadata !"_Z11signal_hitsfRN3hls6streamIfEES2_RNS0_IiEE", metadata !870, i32 3, metadata !871, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (float, %"class.hls::stream.29"*, %"class.hls::stream.29"*, %"class.hls::stream.0.30"*)* @signal_hits, null, null, metadata !87, i32 6} ; [ DW_TAG_subprogram ]
...
!2758 = metadata !{i32 786689, metadata !869, metadata !"threshold", metadata !870, i32 16777219, metadata !873, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2759 = metadata !{i32 3, i32 28, metadata !869, null}
!2760 = metadata !{i32 786689, metadata !869, metadata !"signals", metadata !870, i32 33554436, metadata !875, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2761 = metadata !{i32 4, i32 19, metadata !869, null}
!2762 = metadata !{i32 786689, metadata !869, metadata !"hits", metadata !870, i32 50331653, metadata !875, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2763 = metadata !{i32 5, i32 19, metadata !869, null}
!2764 = metadata !{i32 786689, metadata !869, metadata !"locs", metadata !870, i32 67108870, metadata !929, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2765 = metadata !{i32 6, i32 19, metadata !869, null}
!2766 = metadata !{i32 131, i32 9, metadata !2767, metadata !2768}
!2767 = metadata !{i32 786443, metadata !982, i32 129, i32 63, metadata !879, i32 6} ; [ DW_TAG_lexical_block ]
!2768 = metadata !{i32 10, i32 22, metadata !2769, null}
!2769 = metadata !{i32 786443, metadata !2770, i32 8, i32 35, metadata !870, i32 2} ; [ DW_TAG_lexical_block ]
!2770 = metadata !{i32 786443, metadata !2771, i32 8, i32 2, metadata !870, i32 1} ; [ DW_TAG_lexical_block ]
!2771 = metadata !{i32 786443, metadata !869, i32 6, i32 25, metadata !870, i32 0} ; [ DW_TAG_lexical_block ]
!2772 = metadata !{i32 146, i32 9, metadata !2773, metadata !2774}
!2773 = metadata !{i32 786443, metadata !981, i32 144, i32 79, metadata !879, i32 5} ; [ DW_TAG_lexical_block ]
!2774 = metadata !{i32 12, i32 4, metadata !2775, null}
!2775 = metadata !{i32 786443, metadata !2769, i32 11, i32 27, metadata !870, i32 3} ; [ DW_TAG_lexical_block ]
!2776 = metadata !{i32 146, i32 9, metadata !2777, metadata !2778}
!2777 = metadata !{i32 786443, metadata !980, i32 144, i32 79, metadata !879, i32 4} ; [ DW_TAG_lexical_block ]
!2778 = metadata !{i32 13, i32 4, metadata !2775, null}
!2779 = metadata !{i32 8, i32 15, metadata !2770, null}
!2780 = metadata !{i32 8, i32 36, metadata !2769, null}
!2781 = metadata !{i32 9, i32 1, metadata !2769, null}
!2782 = metadata !{i32 786689, metadata !982, metadata !"this", metadata !879, i32 16777345, metadata !2783, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2783 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !877} ; [ DW_TAG_pointer_type ]
!2784 = metadata !{i32 129, i32 56, metadata !982, metadata !2768}
!2785 = metadata !{i32 786688, metadata !2767, metadata !"tmp", metadata !879, i32 130, metadata !874, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2786 = metadata !{i32 130, i32 22, metadata !2767, metadata !2768}
!2787 = metadata !{i32 132, i32 9, metadata !2767, metadata !2768}
!2788 = metadata !{i32 786688, metadata !2769, metadata !"currAmp", metadata !870, i32 10, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2789 = metadata !{i32 11, i32 3, metadata !2769, null}
!2790 = metadata !{i32 786689, metadata !981, metadata !"this", metadata !879, i32 16777360, metadata !2783, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2791 = metadata !{i32 144, i32 48, metadata !981, metadata !2774}
!2792 = metadata !{i32 786688, metadata !2773, metadata !"tmp", metadata !879, i32 145, metadata !874, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2793 = metadata !{i32 145, i32 22, metadata !2773, metadata !2774}
!2794 = metadata !{i32 145, i32 31, metadata !2773, metadata !2774}
!2795 = metadata !{i32 786689, metadata !980, metadata !"this", metadata !879, i32 16777360, metadata !2796, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2796 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !931} ; [ DW_TAG_pointer_type ]
!2797 = metadata !{i32 144, i32 48, metadata !980, metadata !2778}
!2798 = metadata !{i32 786688, metadata !2777, metadata !"tmp", metadata !879, i32 145, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2799 = metadata !{i32 145, i32 22, metadata !2777, metadata !2778}
!2800 = metadata !{i32 145, i32 31, metadata !2777, metadata !2778}
!2801 = metadata !{i32 14, i32 3, metadata !2775, null}
!2802 = metadata !{i32 15, i32 2, metadata !2769, null}
!2803 = metadata !{i32 8, i32 30, metadata !2770, null}
!2804 = metadata !{i32 786688, metadata !2770, metadata !"i", metadata !870, i32 8, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2805 = metadata !{i32 17, i32 1, metadata !2771, null}
