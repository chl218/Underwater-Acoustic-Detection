...
void parse_audio_sig_buf::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void parse_audio_sig_buf::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void parse_audio_sig_buf::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void parse_audio_sig_buf::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
