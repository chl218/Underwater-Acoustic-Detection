...
set Reference30 "0"
set Dims30 [list 0]
set Interface30 [list AP_STREAM 0] 
...
set Reference31 "0"
set Dims31 [list 0]
set Interface31 [list AP_STREAM 0] 
set DataType31 "int"
...
set DataType3 [list "DSTREAM_STRUCT_PAIR" "struct " $structMem3 0 0 $structParameter3 $structArgument3 $NameSpace3 $structIsPacked3]
