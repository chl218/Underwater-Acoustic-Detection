...
#ifndef __detect_calls_fcmpbkb__HH__
#define __detect_calls_fcmpbkb__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(detect_calls_fcmpbkb) {
    ...
    SC_CTOR(detect_calls_fcmpbkb):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
